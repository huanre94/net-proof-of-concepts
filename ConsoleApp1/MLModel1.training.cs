...
namespace ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\HRESTRE\Downloads\sentiment labelled sentences\imdb_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=13,MinimumExampleCountPerLeaf=13,NumberOfTrees=14,MaximumBinCountPerFeature=201,FeatureFraction=0.899573998918896,LearningRate=0.105495610078653,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
